...
namespace Game.Orbit
{
   ...
   public class Orbit
   {
      ...
      private int m_RevAtEpoch;
      private int m_TleSetNumber;
      ...
      public int RevAtEpoch        { get { return m_RevAtEpoch; } }
      public int TleSetNumber      { get { return m_TleSetNumber; } }
      ...
      public string IntlDesignator { get { return Tle.IntlDesignator; } }
      ...
      public Orbit(Tle tle)
      {
         ...
         m_RevAtEpoch   = (int)Tle.GetField(Tle.Field.RevAtEpoch);
         m_TleSetNumber = (int)Tle.GetField(Tle.Field.SetNumber);

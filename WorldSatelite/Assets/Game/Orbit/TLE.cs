...
namespace Game.Orbit
{
   ...
   public class Tle
   {
      ...
      public string Name  { get { return m_Line0; } }
      ...
      {
         get { return GetField(Field.IntlDesignator, false); }
      }
      ...
      public string RevAtEpoch
      {
         get { return GetField(Field.RevAtEpoch, false); }
      }
      ...
      private void Initialize()
      {
         ...
         m_Field[Field.IntlDesignator] = m_Line1.Substring(TLE1_COL_INTLDESC_A,
               TLE1_LEN_INTLDESC_A +
               TLE1_LEN_INTLDESC_B +
               TLE1_LEN_INTLDESC_C).
         ...
         if (string.IsNullOrEmpty(m_Field[Field.SetNumber]))
         {
            m_Field[Field.SetNumber] = "0";
         }
         ...
         m_Field[Field.RevAtEpoch] = 
            m_Line2.Substring(TLE2_COL_REVATEPOCH, TLE2_LEN_REVATEPOCH).TrimStart();

         if (string.IsNullOrEmpty(m_Field[Field.RevAtEpoch]))
         {
            m_Field[Field.RevAtEpoch] = "0";
         }
      }
      ...
      /// <summary>
      /// Gets the requested units as a string.
      /// </summary>
